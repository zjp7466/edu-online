...
//        alipayRequest.setReturnUrl("http://domain.com/CallBack/return_url.jsp");
        alipayRequest.setNotifyUrl(" http://rcvx6r.natappfree.cc/orders/paynotify");//在公共参数中设置回跳和通知地址
        alipayRequest.setBizContent("{" +
                "    \"out_trade_no\":\"1654359883372683264\"," +
                "    \"total_amount\":100.0," +
                "    \"subject\":\"赵俊鹏 \"," +
    ...
    public void paynotify(HttpServletRequest request,HttpServletResponse response) throws Exception, AlipayApiException {
