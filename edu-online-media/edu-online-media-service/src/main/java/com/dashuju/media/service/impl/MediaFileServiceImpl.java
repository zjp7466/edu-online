package com.dashuju.media.service.impl;
...
import com.dashuju.media.mapper.MediaFilesMapper;
import com.dashuju.media.mapper.MediaProcessMapper;
...
import com.dashuju.media.model.po.MediaProcess;
import com.dashuju.media.service.MediaFileService;
...
//      String objectName = defaultFolderPath + fileMd5 + substring;
    ...
    //上传文件的时候,需要告诉服务器文件类型(即Content-Type),这时,需要获取文件的MIMEType
    ...
    public boolean addMediaFilesToMinIO(String localFilePath,String mimeType,String bucket, String objectName) {
        try {
            ...
            EduOnlineException.cast("上传文件到文件系统失败");
        }
        return false;
    }
    ...
    public MediaFiles addMediaFilesToDb(Long companyId,String fileMd5,UploadFileParamsDto uploadFileParamsDto,String bucket,String objectName){
        ...
        if (mediaFiles == null) {
            ...
            if (insert < 0) {
                ...
                EduOnlineException.cast("保存文件信息失败");
            }
    ...
    @Override
    @Transactional
    public void deleteMiniOVideo(String mediaId) {//video/1/f/1f229319d6fed3431d2f9d06193a433b/1f229319d6fed3431d2f9d06193a433b.mp4
        if (mediaId == null) EduOnlineException.cast("异常！");
        String i = mediaId.substring(0, 1);
        String i1 = mediaId.substring(1, 2);
        String objectName = i + i1 + mediaId;
        RemoveObjectArgs removeObjectArgs = RemoveObjectArgs.builder().object(objectName).bucket(bucket_videoFiles).build();
        try {
            minioClient.removeObject(removeObjectArgs);
        } catch (Exception e) {
            EduOnlineException.cast("minio删除媒资视频异常");
        }
        //删除表数据
