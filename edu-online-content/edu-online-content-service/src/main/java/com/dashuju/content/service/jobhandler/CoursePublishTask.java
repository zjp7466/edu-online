package com.dashuju.content.service.jobhandler;


import com.dashuju.base.execption.EduOnlineException;
import com.dashuju.content.feignclient.SearchServiceClient;
...
import com.dashuju.messagesdk.service.MessageProcessAbstract;
...
//    }
    ...
    private Boolean saveCourseIndex(Long courseId) {
        ...
        if(!add){
            EduOnlineException.cast("添加索引失败");
        }
        return add;
    }
